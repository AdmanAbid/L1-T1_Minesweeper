...
void initiateGame()
{
    ...
    strcpy(IMAGE[0][29], "Images/Light/loginpage.bmp");
    strcpy(IMAGE[0][30], "Images/Light/pointer.bmp");
    strcpy(IMAGE[0][31], "Images/Light/login.bmp");
    strcpy(IMAGE[0][32], "Images/Light/register.bmp");
